...
def test(file1, file2):
    ...
    image1_path, image2_path = detect_and_save_faces_mtcnn(
        image1, image2, output_filename1, output_filename2)
    ...
    if embeddings_image1 and embeddings_image2:
        ...
        cosine_dist = findCosineDistance(
            embeddings_image1[0], embeddings_image2[0])
        return cosine_dist
